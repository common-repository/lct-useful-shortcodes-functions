...
<script type="text/html" id="tmpl-lct_internal_link-shortcode-default-edit-form">

	<form class="lct-edit-shortcode-form">

		<h2 class="lct-edit-shortcode-form-title">Insert An Internal Link</h2>
		...
		<div>
			<a href="javascript:void(0);" onclick="jQuery('#lct-edit-shortcode-form-advanced-attrs').toggle();">Other Options (optional)</a>
		</div>
		<br/>
		...
		<input id="lct_internal_link-update-shortcode" type="button" class="button-primary" value="Update Internal Link"/>
		<input id="lct_internal_link-insert-shortcode" type="button" class="button-primary" value="Insert Internal Link"/>&nbsp;&nbsp;&nbsp;
		<a id="lct_internal_link-cancel-shortcode" class="button" style="color:#bbb;" href="#">Cancel</a>
