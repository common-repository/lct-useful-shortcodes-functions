<?php
/**
 * `{zxzu}serialize`: Single word, no spaces. Underscores allowed. e.g. donate_button
 * `Serialized Data`: Multiple words, can include spaces, visible when selecting a field type. e.g. Donate Button
 *
 * @since        7.29
 * @verified     2016.11.10
...
if ( ! class_exists( 'acf_field_lct_serialize' ) ) :


	class acf_field_lct_serialize extends acf_field
	{
		public $name;
		public $label;
		public $category;
		...
		function __construct()
		{
			 ...
			 */
			$this->name = zxzu( 'serialize' );

			/**
			 * label (string) Multiple words, can include spaces, visible when selecting a field type
			 */
			$this->label = __( 'Serialized Data', 'TD_LCT' );
	...
	acf_register_field_type( 'acf_field_lct_serialize' );
