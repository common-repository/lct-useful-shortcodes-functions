...
if ( ! class_exists( 'acf_field_FIELD_NAME_4' ) ) :


	class acf_field_FIELD_NAME_4 extends acf_field
	{
		...
		*/
		...
		function input_admin_enqueue_scripts()
		{
			...
			// register & include JS
			wp_register_script( 'acf-input-FIELD_NAME', "{$url}assets/js/input.js", [ 'acf-input' ], $version );
			wp_enqueue_script( 'acf-input-FIELD_NAME' );


			// register & include CSS
			wp_register_style( 'acf-input-FIELD_NAME', "{$url}assets/css/input.css", [ 'acf-input' ], $version );
