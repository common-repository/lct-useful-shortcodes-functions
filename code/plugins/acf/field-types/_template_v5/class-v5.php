<?php
/**
 * `{zxzu}FIELD_NAME`: Single word, no spaces. Underscores allowed. e.g. donate_button
...
new acf_field_FIELD_FULL_NAME();


class acf_field_FIELD_FULL_NAME extends acf_field
{
	public $name;
	public $label;
	public $category;
	...
	function __construct()
	{
		 ...
		 */
		$this->name = zxzu( 'FIELD_NAME' );

		/**
		 * label (string) Multiple words, can include spaces, visible when selecting a field type
		 */
		$this->label = __( 'FIELD_LABEL', 'TD_LCT' );
